...
package com.shubh.anililitv.ui.search
            ...
            Column(
                ...
                Row(
                    ...
                    Button(
                        ...
                        modifier = Modifier.height(56.dp).focusHighlight(RectangleShape, customBorderColor = androidx.compose.ui.graphics.Color.White),
                        shape = RectangleShape,
                    ) {
                ...
                LazyRow(
                    modifier = Modifier.fillMaxWidth().focusGroup().padding(top = 8.dp),
                    ...
                    items(options.genres.take(14), key = { it }) { genre ->
                        val isSelected = genre in vm.filters.genres
                        com.shubh.anililitv.ui.components.CustomFilterChip(
                            selected = isSelected,
