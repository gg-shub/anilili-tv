...
import com.shubh.anililitv.diagnostics.CrashReportDialog
...
import com.shubh.anililitv.ui.detail.DetailScreen
import com.shubh.anililitv.ui.FlixcloudResolverWebView
import com.shubh.anililitv.ui.home.HomeScreen
import com.shubh.anililitv.ui.PipeWebView
import com.shubh.anililitv.ui.adaptive.LocalAppDeviceProfile
import com.shubh.anililitv.ui.adaptive.focusHighlight
import com.shubh.anililitv.ui.adaptive.rememberAppDeviceProfile
import com.shubh.anililitv.ui.nav.Routes
import com.shubh.anililitv.ui.notifications.NotificationsScreen
import com.shubh.anililitv.ui.profile.ProfileScreen
import com.shubh.anililitv.ui.schedule.ScheduleScreen
import com.shubh.anililitv.ui.search.SearchScreen
import com.shubh.anililitv.ui.settings.SettingsScreen
import com.shubh.anililitv.ui.settings.UpdatePromptHost
import com.shubh.anililitv.ui.theme.MiruroTheme
import com.shubh.anililitv.ui.watch.WatchScreen
import com.shubh.anililitv.playback.PlaybackStatus
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            ...
            if (SettingsStore.updateCheckOnLaunch.value) {
                UpdateManager.autoCheckIfDue(this@MainActivity)
            }
...
private enum class Tab(
    ...
    SEARCH(Routes.SEARCH, "Explore", Icons.Default.Explore),
    SCHEDULE(Routes.SCHEDULE, "Schedule", Icons.Default.DateRange),
    MORE(Routes.MORE, "Library", Icons.Default.VideoLibrary),
    ...
    NavHost(
        ...
        popExitTransition = { androidx.compose.animation.fadeOut(animationSpec = androidx.compose.animation.core.tween(300)) }
            ...
            composable(Routes.HOME) {
                ...
                HomeScreen(
                    onAnimeClick = { id -> nav.navigate(Routes.detail(id)) { launchSingleTop = true } },
                    onWatchNow = { id ->
                        val saved = com.shubh.anililitv.data.library.LibraryStore.historyFor(id)
                        if (saved != null) nav.navigate(Routes.watch(id, saved.provider, saved.category, saved.episodeLabel))
                        else nav.navigate(Routes.watch(id, "auto", if (com.shubh.anililitv.data.settings.SettingsStore.preferDub.value) "dub" else "sub", "1"))
                    },
            ...
            composable(
                ...
                DetailScreen(
                    animeId = id,
                    onBack = { nav.popBackStack() },
                    onPlay = { animeId, provider, category, episode ->
                        nav.navigate(Routes.watch(animeId, provider, category, episode))
                    },
                    ...
                    onSeasonWatch = { seasonId ->
                        if (seasonId != id) nav.navigate(Routes.detail(seasonId))
                    },
                )
            }
