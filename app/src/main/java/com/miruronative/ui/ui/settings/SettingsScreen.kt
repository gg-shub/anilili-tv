...
fun SettingsScreen(
    ...
    val malLoggedIn by com.miruronative.data.auth.MalAuthManager.loggedIn.collectAsState()
        ...
        if (uri != null) {
            scope.launch {
                try {
                    ...
                    if (bytes != null) {
                        val entries = com.miruronative.data.library.MalImport.parse(bytes)
        ...
        LazyColumn(
            ...
            item {
                SettingSelection(
                    ...
                    options = com.miruronative.data.settings.DefaultQuality.entries,
                    labelFor = { it.label },
            ...
            item { SettingsSectionTitle("List Sync") }
            ...
            item {
                SettingsAction(
                    ...
                    onClick = {
                        scope.launch {
                            kotlinx.coroutines.withContext(kotlinx.coroutines.Dispatchers.IO) { com.miruronative.data.cache.CacheManager.clear(context) }
